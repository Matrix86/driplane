...
|-----------------|----------|---------|-----------------------------------------------------------------------------------------------------------------------------------------------------|
| **url**         | _STRING_ | empty   | URL of the web page. It is possible use [templates]({{< ref "/doc/rules/templates" >}}) to use fields of the `Message`                |
| **download_to** | _STRING_ | empty   | path of where to download the file. It is possible use [templates]({{< ref "/doc/rules/templates" >}}) to use fields of the `Message` | 
