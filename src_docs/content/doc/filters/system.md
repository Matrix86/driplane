...
It supports [templates](/doc/rules/templates) with [Sprig functions](/doc/rules/templates/#sprig-functions).

### Parameters

| Parameter | Type     | Default | Description                                                                                                         |
|-----------|----------|---------|---------------------------------------------------------------------------------------------------------------------|
| **cmd**   | _STRING_ | empty   | command line to exec for each received Message (supports [templates](/doc/rules/templates)) |
