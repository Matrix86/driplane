...
[Go templates](/doc/rules/templates) and it can load templates from the `template_path`
directory specified in the configuration file. All [Sprig functions](/doc/rules/templates/#sprig-functions) are available.
...
| **template** | _STRING_ | empty   | a template could be specified directly here, instead of load it from file (supports [templates](/doc/rules/templates))                       |
| **file**     | _STRING_ | empty   | load the template from file (supports [templates](/doc/rules/templates))                                                                     |
